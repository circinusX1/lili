...
struct Request {
    ...
    const char* headerAt(const char* key)const
    {
        for(const auto& hi : headers)
        {
            const HeaderItem* phi = &(hi);
            if(phi->name==key)
                return phi->value.c_str();
        }
        return "";
    }
};
        ...
        while( begin != end )
        {
            ...
            case HeaderLineStart:
                ...
                else
                {
                    ...
                    req.headers.back().name.reserve(32);
                    req.headers.back().value.reserve(32);
            ...
            case HeaderValue:
                ...
                else
                {
                    ...
                    {
                        Request::HeaderItem hi;
                        req.headers.push_back(hi);
                    }
                }
                break;
