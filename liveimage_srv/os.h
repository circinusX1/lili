...
// Tue Jan 29 18:01:38 2019
inline kchar*  strweb_time()
{
    ...
    size_t millisec = int(tv.tv_usec/1000.0); // Round to nearest millisec
    ...
    strftime(buffer,sizeof(buffer)-1,"%a,%b %d %Y %H:%M:%S %Z",tm_info);
    return buffer;
}
